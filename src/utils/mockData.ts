...
export const mockMutualFunds: MutualFund[] = [
  ...
  },
  {
    ...
    change: 0.85,
    changePercent: 0.72,
    description: 'The fund seeks to track the performance of the CRSP US Total Market Index, which represents approximately 100% of the investable U.S. stock market.',
    expenseRatio: 0.0004,
    yield: 0.014,
    riskLevel: 'Moderate',
    oneYearReturn: 16.5,
  },
  {
    ...
    change: -0.02,
    changePercent: -0.18,
    description: 'The fund seeks to track the performance of the Bloomberg Barclays U.S. Aggregate Float Adjusted Index, which represents a wide spectrum of public, investment-grade, taxable, fixed income securities in the United States.',
    expenseRatio: 0.0005,
    yield: 0.025,
    riskLevel: 'Low',
    oneYearReturn: 3.7,
  },
  {
    ...
    change: 0.28,
    changePercent: 0.87,
    description: 'The fund seeks to track the performance of the FTSE Global All Cap ex US Index, a market-capitalization-weighted index designed to measure equity market performance of companies located in developed and emerging markets, excluding the United States.',
    expenseRatio: 0.0011,
    yield: 0.032,
    riskLevel: 'Moderate-High',
    oneYearReturn: 12.8,
  },
  {
    ...
    change: 0.15,
    changePercent: 0.33,
    description: 'The fund provides long-term capital appreciation and moderate current income by investing in a balanced portfolio of stocks and high-quality bonds.',
    expenseRatio: 0.0025,
    yield: 0.028,
    riskLevel: 'Moderate',
    oneYearReturn: 10.5,
  },
  {
    ...
    change: 0.32,
    changePercent: 1.74,
    description: 'The fund invests primarily in companies with above-average growth potential, focusing on those that are industry leaders with strong competitive advantages.',
    expenseRatio: 0.0083,
    yield: 0.001,
    riskLevel: 'High',
    oneYearReturn: 22.4,
  },
  {
    ...
    change: 0.65,
    changePercent: 0.87,
    description: 'The fund seeks long-term capital growth by investing in stocks of companies that have the potential for above-average earnings growth.',
    expenseRatio: 0.0065,
    yield: 0.003,
    riskLevel: 'Moderate-High',
    oneYearReturn: 19.8,
  },
  {
    ...
    change: -0.85,
    changePercent: -0.36,
    description: 'The fund seeks long-term growth of principal and income by investing primarily in a diversified portfolio of equity securities.',
    expenseRatio: 0.0052,
    yield: 0.016,
    riskLevel: 'Moderate',
    oneYearReturn: 13.2,
...
export const mockDigitalGold: DigitalGold[] = [
  ...
  {
    id: 'DG4',
    name: 'Malabar Gold Digi Gold',
    pricePerGram: 61.45,
    change: 0.18,
    changePercent: 0.29,
    description: 'Buy digital gold from one of India\'s most trusted jewelers. Convert to physical jewelry anytime.',
    purity: '99.9% Purity',
    storageFees: 'Free for 5 years',
    minimumQuantity: 0.01,
  },
  {
    id: 'DG5',
    name: 'Caratlane DigiGold',
    pricePerGram: 61.65,
    change: -0.05,
    changePercent: -0.08,
    description: 'Buy digital gold and convert it to jewelry designs of your choice. Secured vault storage.',
    purity: '24K (99.9%)',
    storageFees: 'Free for 3 years',
    minimumQuantity: 0.02,
  },
  {
    id: 'DG6',
    ...
    change: 0.25,
    changePercent: 0.41,
    description: 'Buy digital gold from Tanishq, a trusted Tata brand. Redeem for jewelry or sell back anytime.',
    purity: '24K (99.99%)',
    storageFees: 'Free for 2 years',
    minimumQuantity: 0.01,
  },
  {
    id: 'DG7',
    name: 'Kalyan Jewellers Gold Savings',
    pricePerGram: 61.40,
    change: -0.10,
    changePercent: -0.16,
    description: 'Accumulate digital gold and redeem for jewelry at any Kalyan Jewellers store.',
    purity: '24K (99.9%)',
    storageFees: 'Free',
    minimumQuantity: 0.005,
  },
  {
    id: 'DG8',
    name: 'Motilal Oswal Gold',
    pricePerGram: 61.58,
    change: 0.12,
    changePercent: 0.20,
    description: 'Invest in digital gold backed by physical gold stored in secure vaults. Sell anytime at market price.',
    purity: '99.99% Purity',
    storageFees: '0.5% per annum',
    minimumQuantity: 0.01,
  },
  {
    id: 'DG9',
    name: 'HDFC Securities Digital Gold',
    pricePerGram: 61.62,
    change: 0.22,
    changePercent: 0.36,
    description: 'Buy and sell 24K digital gold with the security of HDFC. Stored in secure vaults with insurance.',
    purity: '99.99% Purity',
    storageFees: '0.25% per annum',
    minimumQuantity: 0.01,
  },
];
